...
from insurance_calc.services.redis.dependency import get_redis_pool
...
from insurance_calc.web.application import get_app
from sqlalchemy.ext.asyncio import (AsyncConnection, AsyncEngine, AsyncSession,
                                    async_sessionmaker, create_async_engine)
from insurance_calc.db.dependencies import get_db_session
from insurance_calc.db.utils import create_database, drop_database
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from insurance_calc.db.meta import meta  # noqa: WPS433
    from insurance_calc.db.models import load_all_models  # noqa: WPS433
